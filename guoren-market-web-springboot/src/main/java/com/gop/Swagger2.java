...
public class Swagger2 {
    ...
    public static final  String token = "eyJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJDVEVXZWIiLCJzdWIiOiIxOCIsImF1ZCI6IndlYiIsImlhdCI6MTU0NDc2OTY1MywiZXhwIjoxNTQ1MTI5NjUzfQ.p-0Ciic_JRKzzhX-yy9dqfCn9gdxl8qKbcVpNdPEZeXDdVubUnNll2tTG3uA6sXysefU-dxJPBzKL1gICOjBXg";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                //页面标题
                .title("Spring Boot 测试使用 Swagger2 构建RESTful API -- exchangeApi")
                //创建人
