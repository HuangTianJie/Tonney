 ...
 *
 */
@Service("checkLoginPasswordWithPhoneLoginStrategy")
@Slf4j
public class CheckLoginPasswordWithPhoneLoginStrategy implements AuthStrategy {
	...
	public void pre(AuthContext authContext) {
		User user = userService.getUserLikePhone(authContext.getUserAccount());
		if (null == user) {
