...
public class NoticeController {
    ...
    //app公告查询
	@RequestMapping(value = "/appNoticeList", method = RequestMethod.GET)
	public List<PublicNotice> appNoticeList() {
		List<PublicNotice> lists = publicNoticeService.queryNoticeByStatus(null);
		return lists;
	}
}
