 ...
 <Worksheet ss:Name="Sheet1">
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="14.4">
   ...
   <Row>
     ...
     <Cell><Data ss:Type="String">冷钱包余额</Data></Cell>
     <Cell><Data ss:Type="String">热钱包余额</Data></Cell>
   ...
   <#list resultList as downloadMap>
      <Row>
        ...
        <Cell><Data ss:Type="String">${downloadMap.hotBalance?string('0.00000000')!''}</Data></Cell>
        <Cell><Data ss:Type="String">${downloadMap.coldBalance?string('0.00000000')!''}</Data></Cell>
