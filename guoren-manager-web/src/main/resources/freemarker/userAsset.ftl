 ...
 <Worksheet ss:Name="Sheet1">
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="14.4">
   ...
   <Row>
    ...
    <Cell><Data ss:Type="String">邮箱地址</Data></Cell>
    <Cell><Data ss:Type="String">币种</Data></Cell>
    <Cell><Data ss:Type="String">可用金额</Data></Cell>
    <Cell><Data ss:Type="String">冻结金额</Data></Cell>
    <Cell><Data ss:Type="String">资产总额</Data></Cell>
   </Row>
   <#list resultList as downloadMap>
      <Row>
        <Cell><Data ss:Type="String">${downloadMap.UID!''}</Data></Cell>
        <Cell><Data ss:Type="String">${downloadMap.email!''}</Data></Cell>
	    <Cell><Data ss:Type="String">${downloadMap.assetCode!''}</Data></Cell>
	    <Cell><Data ss:Type="String">${downloadMap.amountAvailable?string('0.00000000')!''}</Data></Cell>
	    <Cell><Data ss:Type="String">${downloadMap.amountLock?string('0.00000000')!''}</Data></Cell>
	    <Cell><Data ss:Type="String">${downloadMap.amountTotal?string('0.00000000')!''}</Data></Cell>
      </Row>
   </#list>
  </Table>
