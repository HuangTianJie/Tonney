...
import com.gop.user.dto.AdminRoleDto;
import com.gop.user.dto.MenuAddRoleDto;
import com.gop.user.dto.MenuRoleDto;
import com.gop.user.dto.RoleDto;
...
public class RoleManagerController {
    ...
    public PageModel<AdminRoleDto> getAdminRoleList(@AuthForHeader AuthContext context, @RequestParam("roleId") Integer roleId,
        ...
        List<AdminRoleDto> lstDtos = pageInfo.getList().stream()
                .filter(adminRole -> administractorService.getAdministractor(adminRole.getAdminId())!=null)
                .map(adminRole -> new AdminRoleDto(
                adminRole,
    ...
    public void updateMenuRole(@AuthForHeader AuthContext context,@RequestBody String menuAddRoleDtos) {
        JSONArray meu = JSON.parseObject(menuAddRoleDtos).getJSONArray("menuAddRoleDtos");
        Integer roleId = JSON.parseObject(menuAddRoleDtos).getInteger("roleId");
    ...
    public List<Menu> getMenuAdmin(@AuthForHeader AuthContext context) {
        Integer uid = tokenHelper.validAndGetDetailFromToken(context.getToke(), Integer.class);
