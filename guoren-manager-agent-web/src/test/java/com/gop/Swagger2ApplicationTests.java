...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT,classes = {GuorenManagerAgentWebSpringbootApplication.class})
@Slf4j
public class Swagger2ApplicationTests {
    ...
    public void generateAsciiDocs() throws Exception {
        ...
        Swagger2MarkupConverter.from(new URL("http://localhost:8280/exchange_agent_manager/v2/api-docs"))
                .withConfig(config)
                .build()
