...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Sheet1">
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="14.4">
   ...
   <Row>
    <Cell><Data ss:Type="String">提现时间(UTC+0)</Data></Cell>
    <Cell><Data ss:Type="String">更新时间(UTC+0）</Data></Cell>
    <Cell><Data ss:Type="String">状态</Data></Cell>
    <Cell><Data ss:Type="String">用户ID</Data></Cell>
    <Cell><Data ss:Type="String">用户Email</Data></Cell>
    <Cell><Data ss:Type="String">提现币种</Data></Cell>
    <Cell><Data ss:Type="String">提现地址</Data></Cell>
    <Cell><Data ss:Type="String">提现金额</Data></Cell>
    <Cell><Data ss:Type="String">提现手续费</Data></Cell>
   </Row>
   <#list resultList as downloadMap>
      <Row>
        <Cell><Data ss:Type="String">${(downloadMap.createDate?string('yyyy-MM-dd HH:mm:ss'))!}</Data></Cell>
        <Cell><Data ss:Type="String">${(downloadMap.updateDate?string('yyyy-MM-dd HH:mm:ss'))!}</Data></Cell>
	    ...
	    <Cell><Data ss:Type="String">${downloadMap.address}</Data></Cell>
	    <Cell><Data ss:Type="String">${downloadMap.amount?string('0.00000000')!''}</Data></Cell>
	    <Cell><Data ss:Type="String">${downloadMap.txFee?string('0.00000000')!''}</Data></Cell>
      </Row>
   </#list>
  </Table>
