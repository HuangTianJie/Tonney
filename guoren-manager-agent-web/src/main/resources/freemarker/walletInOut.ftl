 ...
 <Worksheet ss:Name="Sheet1">
  <Table x:FullColumns="1" x:FullRows="1" ss:DefaultRowHeight="14.4">
   ...
   <Row>
     ...
     <Cell><Data ss:Type="String">充值总额</Data></Cell>
     <Cell><Data ss:Type="String">提现总额</Data></Cell>
     <Cell><Data ss:Type="String">前期余额</Data></Cell>
     <Cell><Data ss:Type="String">平台总资产余额</Data></Cell>

   </Row>
   <#list resultList as downloadMap>
      <Row>
        <Cell><Data ss:Type="String">${downloadMap.assetCode}</Data></Cell>
        <Cell><Data ss:Type="String">${downloadMap.depositAmount?string('0.00000000')!''}</Data></Cell>
        <Cell><Data ss:Type="String">${downloadMap.withDrawAmount?string('0.00000000')!''}</Data></Cell>
        <Cell><Data ss:Type="String">${downloadMap.preAmount?string('0.00000000')!''}</Data></Cell>
        <Cell><Data ss:Type="String">${downloadMap.total?string('0.00000000')!''}</Data></Cell>
      </Row>
   </#list>
  </Table>
