...
public class UserServiceImpl implements UserService {
	...
	@Override
	public void updateUserEmail(String email, Integer uid) {

		userMapper.updateUserEmail(email, uid);
	...
	public User getUserLikePhone(String phone) {
		User user = userMapper.selectUserLikeLoginPhone(phone);
		return user;
	}
}
