...
import com.gop.c2c.dto.C2cWechatpayInfoDto.C2cWechatpayInfoDtoBuilder;
...
public class C2cPayFacadeImpl implements C2cPayFacade {
	...
	public C2cBasePayChannelDto getbasicPayChannelDtoByPaymentDetail(C2cOrderPaymentDetail orderPaymentDetail) {
		...
		case WECHAT:
			C2cWeChatInfo info  = c2cWechatService.selectStatusUsingByUid(orderPaymentDetail.getUid());
			C2cWechatpayInfoDtoBuilder WechatBuilder = C2cWechatpayInfoDto.builder();
			C2cWechatpayInfoDto c2cWechatInfoDto = WechatBuilder.tag(info.getTag()).uid(info.getUid()).build();
			dto = c2cWechatInfoDto;
			break;
